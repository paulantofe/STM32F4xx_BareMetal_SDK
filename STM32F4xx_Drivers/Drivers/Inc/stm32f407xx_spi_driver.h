...
/**
 * @defgroup SPI_SCLK_PRESCALER   Serial Clock Prescaler
 * @{
 */
#define SPI_CLK_PRESCALER_DIV2    0
#define SPI_CLK_PRESCALER_DIV4    1
#define SPI_CLK_PRESCALER_DIV8    2
#define SPI_CLK_PRESCALER_DIV16   3
#define SPI_CLK_PRESCALER_DIV32   4
#define SPI_CLK_PRESCALER_DIV64   5
#define SPI_CLK_PRESCALER_DIV128  6
#define SPI_CLK_PRESCALER_DIV256  7
/** @} */
...
typedef struct {
	...
	uint8_t SPI_ClkPrescaler;     /**< possible values from @ref SPI_SCLK_PRESCALER  */
...
uint8_t SPI_ReceiveIT(SPI_Handle_t *pSPIHandle, uint8_t *pTxBuffer, uint32_t Len);
